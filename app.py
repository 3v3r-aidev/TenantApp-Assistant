...
from write_to_excel_template import write_multiple_applicants_to_template, write_to_summary_template
    ...
    if selected_df.empty:
        ...
        if not os.path.exists(template_to_use):
            ...
            try:
                ...
                st.session_state["summary_filename"] = "App_Summary_Template.xlsx"
...
if "summary_output_bytes" in st.session_state and "summary_filename" in st.session_state:
    st.sidebar.download_button(
        label="⬇️ Download App Summary Template",
